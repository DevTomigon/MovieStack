document.addEventListener("DOMContentLoaded", () => {
  ...
  const imageBaseUrl = "https://moviestack.onrender.com/static/";
    ...
    if (selectedMovie) {
      ...
      detallesContainer.innerHTML = `
        <div class="flex-1 mr-3 bg-black rounded-xl h-[450px] text-white mt-4 ml-4 flex items-center justify-center flex-col">
          <img src="${imageBaseUrl + selectedMovie.image}" alt="${selectedMovie.title}" class="mt-4 mr-4 p-4">
          <table class="mt-5 ml-3 w-[300px] p-4 mb-7">
            <tr>
              <td class="bg-white text-gray-900">Original Language:</td>
              <td class="bg-white text-gray-900">${selectedMovie.original_language}</td>
            </tr>
            <tr>
              <td class="bg-gray-400">Release Date:</td>
              <td class="bg-gray-400">${selectedMovie.release_date}</td>
            </tr>
            <tr>
              <td class="bg-white text-gray-900">Runtime:</td>
              <td class="bg-white text-gray-900">${selectedMovie.runtime} minutes</td>
            </tr>
            <tr>
        ...
        <div class="flex-1 border border-black text-white mr-3 bg-black rounded-xl h-[450px] mt-4 ml-4 pb-4 text-center justify-center items-center flex flex-col">
          <h1 class="text-2xl font-bold text-cyan-500 mt-4 bg-white rounded-md">${selectedMovie.title}</h1>
